    ...
    <div>
     <div className='App'>
        ...
        <div className='flex justify-center'>
          ...
          <button className='text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700' onClick={() => handleClear(setCode,setInput)}>Clear</button>
        </div>
        <br />
        <div className='flex justify-center'>
          <textarea value={loading ? 'Loading...' : output} readOnly rows="10" cols="16                            0" className='resize p-5 block p-2.5 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'></textarea>
